...
void useItem(Player& player, Monster& monster, int playerInt, int monsterInt); // placeholder, function needs redefining
void useSkill(Player& player, Monster& monster, int playerInt, int monsterInt);	// placeholder, function needs redefining
